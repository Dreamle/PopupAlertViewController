...
@protocol BasePopupViewControllerDelegate<NSObject>
@optional
/**
...
- (void)PopViewController:(UIViewController *)controller  didTapMaskViewWithMaskView:(UIView *)maskView;
@end
...
@property(nonatomic,weak)id<BasePopupViewControllerDelegate>popupDelegate;
